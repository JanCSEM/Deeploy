...
from Deeploy.Targets.Generic.Bindings import BasicAddBindings, BasicBatchNormBindings, BasicConcatBindings, \
    ...
    BasicSliceBindings, BasicSoftmaxBindings, BasicTransposeBindings, DummyBinding, BasicPerturbNormalBindings, \
...
from Deeploy.Targets.Generic.Layers import AddLayer, BatchNormalizationLayer, ConcatLayer, ConvLayer, \
    ...
    TransposeLayer, PerturbNormalLayer, PerturbUniformLayer
from Deeploy.Targets.Generic.Parsers import AddParser, BatchNormParser, ConcatParser, ConvTranspose1DParser, \
    ...
    iLayerNormParser, iSoftmaxParser, PerturbNormalParser, PerturbUniformParser
...
PerturbNormalMapper = NodeMapper(PerturbNormalParser(), BasicPerturbNormalBindings)
PerturbUniformMapper = NodeMapper(PerturbUniformParser(), BasicPerturbUniformBindings)
